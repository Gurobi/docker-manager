...
* [13.0.0beta](https://github.com/Gurobi/docker-manager/blob/master/13.0.0/Dockerfile)
...
[example](https://github.com/Gurobi/docker-manager/blob/master/13.0.0/k8s.yaml).
...
2024-03-05T16:12:51Z - info  : Available runtimes: [11.0.0 11.0.1 11.0.2 11.0.3 12.0.0 12.0.1 12.0.2 12.0.3 13.0.0]
