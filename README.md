...
* [12.0.2, latest](https://github.com/Gurobi/docker-manager/blob/master/12.0.2/Dockerfile)
...
[example](https://github.com/Gurobi/docker-manager/blob/master/12.0.2/k8s.yaml).
...
2024-03-05T16:12:51Z - info  : Version is 12.0.2 (build v12.0.2rc0)
...
2024-03-05T16:12:51Z - info  : Available runtimes: [10.0.0 10.0.1 10.0.2 10.0.3 11.0.0 11.0.1 11.0.2 11.0.3 12.0.0 12.0.1, 12.0.2]
...
A simple deployment file is provided as an
[example](https://github.com/Gurobi/docker-manager/blob/master/12.0.2/daemonset.yaml).
