...
* [11.0.3, latest](https://github.com/Gurobi/docker-manager/blob/master/11.0.3/Dockerfile)
...
Supported architectures: inux/amd64, linux/arm64
...
[example](https://github.com/Gurobi/docker-manager/blob/master/11.0.3/k8s.yaml).
...
2024-03-05T16:12:51Z - info  : Version is 11.0.3 (build v11.0.3rc0)
...
2024-03-05T16:12:51Z - info  : Available runtimes: [10.0.0 10.0.1 10.0.2 10.0.3 11.0.0 11.0.1 11.0.2 11.0.3 9.5.0 9.5.1 9.5.2]
...
A simple deployment file is provided as an
[example](https://github.com/Gurobi/docker-manager/blob/master/11.0.3/daemonset.yaml).
