<img src="logo.png" alt="Logo" title="Gurobi Optimization" />
# Quick reference
...
* [13.0.2, latest](https://github.com/Gurobi/docker-manager/blob/master/13.0.2/Dockerfile)
...
[example](https://github.com/Gurobi/docker-manager/blob/master/13.0.2/k8s.yaml).
...
2024-03-05T16:12:51Z - info  : Version is 13.0.2 (build v13.0.2rc1)
...
2024-03-05T16:12:51Z - info  : Available runtimes: [11.0.0 11.0.1 11.0.2 11.0.3 12.0.0 12.0.1 12.0.2 12.0.3 13.0.0 13.0.1, 13.0.2]
