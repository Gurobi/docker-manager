...
*[10.0.3, latest](https://github.com/Gurobi/docker-manager/blob/master/10.0.3/Dockerfile)
*[10.0.2, latest](https://github.com/Gurobi/docker-manager/blob/master/10.0.2/Dockerfile)
...
[example](https://github.com/Gurobi/docker-manager/blob/master/10.0.3/k8s.yaml).
...
2023-02-01T19:35:30Z - info  : Version is 10.0.3 (build v10.0.2rc0)
...
2023-02-01T19:35:30Z - info  : Platform is linux
2023-02-01T19:35:30Z - info  : Version is 10.0.3 (build v10.0.1rc0)
...
2023-02-01T19:35:30Z - info  : Available runtimes: [10.0.0 10.0.1 10.0.2 10.0.3 9.0.0 9.0.1 9.0.2 9.0.3 9.1.0 9.1.1 9.1.2 9.5.0 9.5.1 9.5.2]
...
A simple deployment file is provided as an
[example](https://github.com/Gurobi/docker-manager/blob/master/10.0.3/daemonset.yaml).
